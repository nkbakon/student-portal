    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <h5 class="font-bold text-center text-gray-900 text-xl">New Cash Out</h5><br>                
                    ...
                    <div class="md:flex">
                        <div>
                            ...
                            <div>
                                ...
                                <input type="number" min="0" step="0.01" name="amount" id="amount" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="amount" required>
